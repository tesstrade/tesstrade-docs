...
<template>
  ...
  >
    ...
    <div v-if="hasPanel" class="tt-inline-search__panel">
      <div class="tt-inline-search__body">
      ...
      <a
        class="tt-inline-search__powered-by"
        href="https://www.algolia.com/ref/docsearch/?utm_source=learn.tesstrade.com&utm_medium=referral&utm_content=powered_by&utm_campaign=docsearch"
        target="_blank"
        rel="noopener noreferrer"
      >
        <span class="tt-inline-search__powered-label">Search by</span>
        <svg
          class="tt-inline-search__algolia-logo"
          width="77"
          height="19"
          aria-label="Algolia"
          role="img"
        ...
        >
          ...
          />
          <rect fill="currentColor" x="1845.88" y="104.73" width="62.58" height="277.9" rx="5.9" ry="5.9" />
          <path
            fill="currentColor"
            fill-rule="evenodd"
...
.tt-inline-search__powered-by:hover {
  color: var(--vp-c-text-2);
}

.tt-inline-search__powered-label {
  font-size: 11px;
  line-height: 16px;
}

.tt-inline-search__algolia-logo {
  display: block;
  width: 58px;
  height: auto;
  color: #003dff;
...
:global(.dark) .tt-inline-search__algolia-logo {
  color: #fff;
}
